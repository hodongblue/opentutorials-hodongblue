<?php
// 1. 데이터베이스 서버에 접속
$link=mysql_connect('54.199.138.184','ubuntu','111111');
if($link) {
	die('Could not connect: '.mysql_error());
}
// 2. 데이터베이스 선택
mysql_select_db('opentutorials');
mysql_query("set session chracter_set_connection=utf8;");
mysql_query("set session chracter_set_result=utf8;");
mysql_query("set session chracter_set_client=utf8;");
if(!empty($_GET['id'])) {
